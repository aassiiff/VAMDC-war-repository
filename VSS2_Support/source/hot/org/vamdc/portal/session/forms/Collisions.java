...
import org.vamdc.portal.session.controller.process.ProcessDefinition;

@Name("collisions")
@Scope(ScopeType.SESSION)
public class Collisions extends AbstractForm {
	...
	public Collisions(){
		processCodeManager = new ProcessCodeManager();
	...
	public void clearFields() {
		System.out.println("Clear Fields Called");
		collisionIAEACode = "";
		collisionCode = "";
		processName = "";
		processDescription ="";
	...
	public List<ProcessDefinition> autoCompleteForProcessName(Object suggest) {
		...
		List<ProcessDefinition> localProcessCodesList = new ArrayList<ProcessDefinition>();
		 ...
		 Iterator<ProcessDefinition> iterator = processCodeManager.getProcessCodesList().iterator();
	        ...
	        System.out.println(localProcessCodesList);
