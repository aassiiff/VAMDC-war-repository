...
import org.domain.vamdc.portal.registry.entity.ExtendedCapability;
import org.domain.vamdc.portal.registry.entity.ExtendedInterface;
...
public class RegistryBrowser {
	...
	public void registryBrowser() {
		...
		String registryURL = System.getProperty("registryURL_dev");
